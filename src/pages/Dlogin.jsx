...
function Dlogin() {
  ...
  return (
    <div className="bg-[#0b1220] min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-orange-500/20 via-transparent to-green-500/20 pointer-events-none"></div>
      ...
      <div className="relative z-10 bg-[#121a2b] p-8 rounded-2xl shadow-2xl w-full max-w-md space-y-6 border border-gray-700">
        ...
        <div className="flex flex-col items-center space-y-3">
          ...
          <p className="text-gray-400 text-sm text-center">
            Access your secure MediChain doctor dashboard
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            ...
            type="submit"
            className="w-full mt-4 px-4 py-3 border-2 border-orange-500 text-orange-400 font-bold rounded-lg hover:bg-orange-500 hover:text-white transition duration-300 shadow-md"
          >
            Login
          </button>
        </form>
